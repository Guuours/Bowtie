...
namespace Dapper.Bowtie
{
    public partial class Connection : IDisposable
    {
        ...
        internal T QuerySingleOrDefault<T>(string statement, object param, int? timeout = null)
        {
            ...
            // query
            var data = RawConnection.QuerySingleOrDefault<T>(statement, param, Transaction, timeout ?? DB.Config.DefaultTimeout, CommandType.Text);
        ...
        internal async Task<T> QuerySingleOrDefaultAsync<T>(string statement, object param, int? timeout = null, CancellationToken cancellationToken = default)
        {
            ...
            // query
            var data = await RawConnection.QuerySingleOrDefaultAsync<T>(new CommandDefinition(statement, param, Transaction, timeout ?? DB.Config.DefaultTimeout, CommandType.Text, CommandFlags.Buffered, cancellationToken));
